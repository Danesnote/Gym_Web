...
<section class="contact-section spad">
	<div class="container">
        ...
        <a href="/member/modify?bno=<c:out value="${board.bno}"/>">Modify</a></button>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-heading"><label>Files</label></div>
					<!-- /.panel-heading -->
					<div class="panel-body">
		...
		<div class='row'>
			...
			<div class="col-lg-12">
				...
				<div class="panel-heading">
					<i class="fa fa-comments fa-fw"></i> <label>Reply</label>
					<sec:authorize access="isAuthenticated()">
...
$(document).ready(function () {
  ...
  /* $.getJSON("/member/getAttachList", {bno: bno}, function(arr){
