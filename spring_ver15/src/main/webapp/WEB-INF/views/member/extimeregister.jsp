					...
					<div class="leave-comment">
						<form action="/member/extimeregister" method="post">
							...
							<div align="center" class="form-group has-feedback">
								<label class="control-label" for="extime_s" style="color: white">운동 시작
									시간(yyyy/MM/dd hh:mm:ss)</label> <input class="form-control" type="text"
									id="extime_s" name="extime_s" />
							</div>
							<div align="center" class="form-group has-feedback" style="color: white">
								<label class="control-label" for="extime_e">운동 종료
									시간(yyyy/MM/dd hh:mm:ss)</label> <input class="form-control" type="text"
									id="extime_e" name="extime_e" />
							</div>
							<div align="center" class="form-group has-feedback">
